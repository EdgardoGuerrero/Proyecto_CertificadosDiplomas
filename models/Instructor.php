<?php 
    class Instructor extends Conectar{
        public function insert_instructor(
            $inst_nom, $inst_apep, $inst_apem, $inst_correo,
            $inst_sex, $inst_telf
        ){
        ...
        public function update_instructor(
            $inst_id, $inst_nom, $inst_apep, $inst_apem, 
            $inst_correo, $inst_sex, $inst_telf
        ){
            $conectar = parent::conexion();
            parent::set_names();
            $sql = "UPDATE tm_instructor SET 
                    inst_nom=?,
                    inst_apep=?,
                    inst_apem=?,
                    inst_correo=?,
        ...
        public function get_instructor_id($inst_id){
            $conectar = parent::conexion();
            parent::set_names();
            $sql = "SELECT * FROM tm_instructor
             WHERE est = 1 and inst_id = ?";
