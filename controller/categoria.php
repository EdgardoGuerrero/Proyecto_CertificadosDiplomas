    ...
    switch($_GET["op"]){
        ...
        case "listar":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" onClick="editar('.$row["cat_id"].')"  id="'.$row["cat_nom"].'" class="btn btn-outline-warning btn-icon"><div><i class="fa fa-edit"></div></button>';
                $sub_array[] = '<button type="button" onClick="eliminar('.$row["cat_id"].')"  id="'.$row["cat_nom"].'" class="btn btn-outline-danger btn-icon"><div><i class="fa fa-close"></i></div></button>';
                $data[] = $sub_array;
            }
