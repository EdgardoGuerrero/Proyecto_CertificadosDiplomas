<?php 
    ...
    switch($_GET["op"]){
        /* Microservicios para poder mostrar el listado de cursos de un usuario con certificado */
        case "listar_cursos":
            ...
            /* Microservicio para mostrar información del certificado con el curd-id */
